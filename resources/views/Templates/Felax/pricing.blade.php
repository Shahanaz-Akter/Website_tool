                            ...
                            <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                                <ul class="navbar-nav">
                                    <li class="nav-item plus-icon">
                                        <a href="pricing.html#" class="nav-link dropdown-toggle">Home <i class="fas fa-angle-down"></i></a>
                                    ...
                                    <li class="nav-item">
                                        <a href="pricing.html#" class="nav-link dropdown-toggle">Rooms<i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="pricing.html#" class="nav-link dropdown-toggle">Services<i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="pricing.html#" class="nav-link dropdown-toggle active">Pages <i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                            <li class="nav-item"><a href="about.html" class="nav-link">About Us</a></li>
                                            <li class="nav-item"><a href="faq.html" class="nav-link">FAQ</a></li>
                                            <li class="nav-item"><a href="team.html" class="nav-link">Our Team</a></li>
                                            <li class="nav-item"><a href="pricing.html" class="nav-link active">Pricing Plan</a></li>
                                    ...
                                    <li class="nav-item">
                                        <a href="pricing.html#" class="nav-link dropdown-toggle">Blog <i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="pricing-card">
                            <div class="pricing-card-header">
                                <h5>Holidays Package</h5>
                                <h3>$20 <sub>/Per Night</sub></h3>
                            </div>
                            <div class="pricing-card-text">
                                <ul>
                                    <li><i class="fas fa-check"></i> Minimum stay 3 nights</li>
                                    <li><i class="fas fa-check"></i> Holiday dinner for free</li>
                                    <li><i class="fas fa-check"></i> Gifts and surprises for children</li>
                                    <li><i class="fas fa-check"></i> Wi Fi in the room</li>
                                    <li><i class="fas fa-times"></i> Maid service included</li>
                                    <li><i class="fas fa-times"></i> Coffee for Free</li>
                                </ul>
                                <a class="default-button" href="booking.html">Book This Room</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="pricing-card pricing-card-active">
                            ...
                            <div class="pricing-card-text">
                                <ul>
                                    ...
                                    <li><i class="fas fa-check"></i> Gifts and surprises for children</li>
                                    <li><i class="fas fa-check"></i> Wi Fi in the room</li>
                                    <li><i class="fas fa-check"></i> Maid service included</li>
                                    <li><i class="fas fa-times"></i> Coffee for Free</li>
                                </ul>
                                <a class="default-button" href="booking.html">Book This Room</a>
                            </div>
                        ...
                        <div class="pricing-card">
                            ...
                            <div class="pricing-card-text">
                                <ul>
                                    ...
                                    <li><i class="fas fa-check"></i> Wi Fi in the room</li>
                                    <li><i class="fas fa-check"></i> Maid service included</li>
                                    <li><i class="fas fa-check"></i> Coffee for Free</li>
                                </ul>
                                <a class="default-button" href="booking.html">Book This Room</a>
                            </div>
                        </div>
                            ...
                            <div class="footer-logo-area">
                                ...
                                <div class="footer-contact">
                                    <ul>
                                        ...
                                        <li><a href="../../cdn-cgi/l/email-protection.html#88e0ede4e4e7c8eeede4e9f0a6ebe7e5"><i class="fas fa-envelope"></i> <span class="__cf_email__" data-cfemail="157d7079797a55737079746d3b767a78">[email&#160;protected]</span></a></li>
