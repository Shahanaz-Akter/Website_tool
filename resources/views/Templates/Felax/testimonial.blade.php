...
<html lang="zxx">
    ...
    <body>
                            ...
                            <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                                <ul class="navbar-nav">
                                    <li class="nav-item plus-icon">
                                        <a href="testimonial.html#" class="nav-link dropdown-toggle">Home <i class="fas fa-angle-down"></i></a>
                                    ...
                                    <li class="nav-item">
                                        <a href="testimonial.html#" class="nav-link dropdown-toggle">Rooms<i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="testimonial.html#" class="nav-link dropdown-toggle">Services<i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="testimonial.html#" class="nav-link dropdown-toggle active">Pages <i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="testimonial.html#" class="nav-link dropdown-toggle">Blog <i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
        ...
        <div class="testimonials pt-70 pb-100">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="testimonial-card-2">
                            ...
                            <h4>Mariana Dickey</h4>
                            <span>Founder - Hilix</span>
                            <p>“Lorem ipsum dolor sit amet, consectetpiscing elit, sed do eiusmod temporncididu labre et dolore magna aliqua. Quis ipsum suspen</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="testimonial-card-2">
                ...
                <div class="paginations mt-30">
                    <ul>
                        <li class="active"><a href="testimonial.html">1</a></li>
                        <li><a href="testimonial.html">2</a></li>
                        <li><a href="testimonial.html">3</a></li>
                        <li><a href="testimonial.html">Next</a></li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            <div class="footer-logo-area">
                                ...
                                <div class="footer-contact">
                                    <ul>
                                        ...
                                        <li><a href="../../cdn-cgi/l/email-protection.html#573f323b3b381731323b362f7934383a"><i class="fas fa-envelope"></i> <span class="__cf_email__" data-cfemail="a5cdc0c9c9cae5c3c0c9c4dd8bc6cac8">[email&#160;protected]</span></a></li>
