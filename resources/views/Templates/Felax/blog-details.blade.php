    ...
    <body>
                            ...
                            <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                                <ul class="navbar-nav">
                                    <li class="nav-item plus-icon">
                                        <a href="blog-details.html#" class="nav-link dropdown-toggle">Home <i class="fas fa-angle-down"></i></a>
                                    ...
                                    <li class="nav-item">
                                        <a href="blog-details.html#" class="nav-link dropdown-toggle">Rooms<i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="blog-details.html#" class="nav-link dropdown-toggle">Services<i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="blog-details.html#" class="nav-link dropdown-toggle">Pages <i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="blog-details.html#" class="nav-link dropdown-toggle active">Blog <i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
        ...
        <div class="blog-details ptb-100">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="blog-details-text-area pr-20">
                            <img class="bd-main-img" src="assets/images/inner-images/bd1.jpg" alt="image">
                            <div class="blog-date">
                                <ul>
                                    <li><i class="far fa-calendar-alt"></i> 04 Sep 2021</li>
                                    <li><i class="far fa-comment"></i> No Comments</li>
                                </ul>
                            </div>
                            <h3>The Seven People You Always Meet Hostelling</h3>
                            <p>We denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal elongs to those who fail in their duty through weakness of will, which is the same as saying through shrinking from toil and pain.</p>
                            ...
                            <div class="blog-quote">
                                ...
                                <h5><i class="fas fa-quote-right"></i> <span>Jonathan</span></h5>
                            </div>
                            <div class="blog-details-text-img-area">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="bd-img-text">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sedo eiusmod tempor incididunt ut labore et dolore maQuis ipsum suspendisse ultrices gravida. Risus commodo vierraaaccumsan lacus vel facilisise it is pleasure, but because those who do not know how to pursue pleasure rationally encounter.</p>
                                            <p>conquences sicalrcise, except to obtain some advantage from it? But who has anright to find fault with a man whom ipsum dolor sit amet, cons etur adipiscing elit, sedo eiusmod tempor incididunt ut lab dolore maQuis ipsum suspendisse ultrices gravida. Risus covierraaaccumsan lacus vel facilisise it is pleasure, but because those.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <p>idem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus, omnis voluptas assumenda est, omnis dolor repndus. Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates diandae sint et molestiae non recusandae. Itaque earum rerum hic tenetur a sapiente delectus.</p>
                        </div>
                        <div class="blog-text-footer mt-30 pr-20">
                            <div class="tag-area">
                                <ul>
                                    <li><i class="fas fa-tags"></i></li>
                                    <li><a href="category.html">Top Tours,</a></li>
                                    <li><a href="category.html">Most Visited,</a></li>
                        ...
                        <div class="bd-form details-text-area pr-20" id="bd-form">
                            ...
                            <form>
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <button class="default-button" type="submit"><span>Post A Comment</span></button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                        <div class="sidebar-content pt-30">
                            ...
                            <div class="sidebar-card categories mt-30">
                                <h3>Categories</h3>
                                <ul>
                                    <li class="active"><a href="category.html"><i class="far fa-caret-square-right"></i> Most Visited Places</a></li>
                                    <li><a href="category.html"><i class="far fa-caret-square-right"></i> Places To Visit</a></li>
                                    <li><a href="category.html"><i class="far fa-caret-square-right"></i> Top Tours</a></li>
                                    <li><a href="category.html"><i class="far fa-caret-square-right"></i> Long Trip Places</a></li>
                                    <li><a href="category.html"><i class="far fa-caret-square-right"></i> Support</a></li>
                                </ul>
                            </div>
                            <div class="sidebar-card recent-news">
                                ...
                                <div class="recent-news-card">
                                    ...
                                    <h5><a href="blog-details.html">The Seven People You Always  Meet Hostelling</a></h5>
                                    <p>4 Sep June 2021</p>
                                </div>
                                <div class="recent-news-card">
                                    <a href="blog-details.html"><img src="assets/images/inner-images/bds2.jpg" alt="image"></a>
                                    <h5><a href="blog-details.html">Benefits Of Online Registration at Your Hotel</a></h5>
                                    <p>8 Sep 2021</p>
                                </div>
                                <div class="recent-news-card">
                                    <a href="blog-details.html"><img src="assets/images/inner-images/bds3.jpg" alt="image"></a>
                                    <h5><a href="blog-details.html">Cottonwood Cove Established Resort & Marina</a></h5>
                                    <p>10 Sep 2021</p>
                                </div>
                            </div>
                            <div class="sidebar-card sd-tag">
                                <h3>Tags</h3>
                                <ul>
                                    <li><a href="category.html">Lorem</a></li>
                                    <li><a href="category.html">Ipsum</a></li>
                                    <li><a href="category.html">Research</a></li>
                                    <li><a href="category.html">Hills</a></li>
                                    <li><a href="category.html">Sea</a></li>
                                    <li><a href="category.html">Support</a></li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="footer-logo-area">
                                ...
                                <div class="footer-contact">
                                    <ul>
                                        ...
                                        <li><a href="../../cdn-cgi/l/email-protection.html#cca4a9a0a0a38caaa9a0adb4e2afa3a1"><i class="fas fa-envelope"></i> <span class="__cf_email__" data-cfemail="2d45484141426d4b48414c55034e4240">[email&#160;protected]</span></a></li>
