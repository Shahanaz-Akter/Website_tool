...
<html lang="zxx">
    ...
    <body>
                            ...
                            <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                                <ul class="navbar-nav">
                                    <li class="nav-item plus-icon">
                                        <a href="rooms.html#" class="nav-link dropdown-toggle">Home <i class="fas fa-angle-down"></i></a>
                                    ...
                                    <li class="nav-item">
                                        <a href="rooms.html#" class="nav-link dropdown-toggle active">Rooms<i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                            <li class="nav-item"><a href="rooms.html" class="nav-link active">Rooms</a></li>
                                            <li class="nav-item"><a href="room-details.html" class="nav-link">Room Details</a></li>
                                        </ul>
                                    </li>
                                    <li class="nav-item">
                                        <a href="rooms.html#" class="nav-link dropdown-toggle">Services<i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="rooms.html#" class="nav-link dropdown-toggle">Pages <i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="rooms.html#" class="nav-link dropdown-toggle">Blog <i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
        ...
        <!-- Room area start -->
        <div class="room pt-70 pb-100">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="room-card-2">
                            <img src="assets/images/rooms/r6.jpg" alt="image">
                            <div class="room-card-2-footer">
                                <h4><a href="room-details.html">Lake View Room</a></h4>
                            </div>
                            <div class="room-card-2-text">
                                <h4><a href="room-details.html">Lake View Room</a></h4>
                                <span>Twin Room</span>
                                <p>Lorem ipsum dolor sit amet, consectetur adicing elit, sed do eiusmod tempor incididulabore et dolore magna aliqua. Quis ipsum </p>
                                <p>From: <strong>$142</strong>/Per Night</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="room-card-2">
                            <img src="assets/images/rooms/r7.jpg" alt="image">
                            <div class="room-card-2-footer">
                                <h4><a href="room-details.html">Queen Room Balcony</a></h4>
                            </div>
                            <div class="room-card-2-text">
                                <h4><a href="room-details.html">Queen Room Balcony</a></h4>
                                <span>Twin Room</span>
                                <p>Lorem ipsum dolor sit amet, consectetur adicing elit, sed do eiusmod tempor incididulabore et dolore magna aliqua. Quis ipsum </p>
                                <p>From: <strong>$80</strong>/Per Night</p>
                                <a class="default-button" href="booking.html">Booking Now</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="room-card-2">
                            <img src="assets/images/rooms/r8.jpg" alt="image">
                            <div class="room-card-2-footer">
                                <h4><a href="room-details.html">Apartment</a></h4>
                            </div>
                            <div class="room-card-2-text">
                                <h4><a href="room-details.html">Apartment</a></h4>
                                <span>Twin Room</span>
                                <p>Lorem ipsum dolor sit amet, consectetur adicing elit, sed do eiusmod tempor incididulabore et dolore magna aliqua. Quis ipsum </p>
                                <p>From: <strong>$132</strong>/Per Night</p>
                                <a class="default-button" href="booking.html">Booking Now</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="room-card-2">
                            <img src="assets/images/rooms/r9.jpg" alt="image">
                            <div class="room-card-2-footer">
                                <h4><a href="room-details.html">Two Storey Building</a></h4>
                            </div>
                            <div class="room-card-2-text">
                                <h4><a href="room-details.html">Two Storey Building</a></h4>
                                <span>Twin Room</span>
                                <p>Lorem ipsum dolor sit amet, consectetur adicing elit, sed do eiusmod tempor incididulabore et dolore magna aliqua. Quis ipsum </p>
                                <p>From: <strong>$152</strong>/Per Night</p>
                                <a class="default-button" href="booking.html">Booking Now</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="room-card-2">
                            <img src="assets/images/rooms/r14.jpg" alt="image">
                            <div class="room-card-2-footer">
                                <h4><a href="room-details.html">Reading Room</a></h4>
                            </div>
                            <div class="room-card-2-text">
                                <h4><a href="room-details.html">Reading Room</a></h4>
                                <span>Twin Room</span>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="room-card-2">
                            <img src="assets/images/rooms/r15.jpg" alt="image">
                            <div class="room-card-2-footer">
                                <h4><a href="room-details.html">Hill View Room</a></h4>
                            </div>
                            <div class="room-card-2-text">
                                <h4><a href="room-details.html">Hill View Room</a></h4>
                                <span>Twin Room</span>
                ...
                <div class="paginations mt-30">
                    <ul>
                        <li class="active"><a href="rooms.html">1</a></li>
                        <li><a href="rooms.html">2</a></li>
                        <li><a href="rooms.html">3</a></li>
                        <li><a href="rooms.html">Next</a></li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            <div class="footer-logo-area">
                                ...
                                <div class="footer-contact">
                                    <ul>
                                        ...
                                        <li><a href="../../cdn-cgi/l/email-protection.html#472f222b2b280721222b263f6924282a"><i class="fas fa-envelope"></i> <span class="__cf_email__" data-cfemail="4b232e2727240b2d2e272a3365282426">[email&#160;protected]</span></a></li>
