                            ...
                            <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                                <ul class="navbar-nav">
                                    <li class="nav-item plus-icon">
                                        <a href="posted-by.html#" class="nav-link dropdown-toggle">Home <i class="fas fa-angle-down"></i></a>
                                    ...
                                    <li class="nav-item">
                                        <a href="posted-by.html#" class="nav-link dropdown-toggle">Rooms<i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="posted-by.html#" class="nav-link dropdown-toggle">Services<i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="posted-by.html#" class="nav-link dropdown-toggle">Pages <i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="posted-by.html#" class="nav-link dropdown-toggle active">Blog <i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="nav-item"><a href="posted-by.html" class="nav-link active">Blog Post</a></li>
                                        </ul>
                                    </li>
        ...
        <div class="blog pt-70 pb-100">
            <div class="container">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="blog-card-2">
                            ...
                            <div class="blog-card-text">
                                <div class="blog-date">
                                    <ul>
                                        <li><i class="far fa-calendar-alt"></i> 12 Sep 2021</li>
                                        <li><i class="far fa-comment"></i> No Comments</li>
                                    </ul>
                                </div>
                                <h4><a href="blog-details.html">Things Hostels Do Better Than Posh Hotels</a></h4>
                                <a class="read-more-button" href="blog-details.html">Read More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="blog-card-2">
                            ...
                            <div class="blog-card-text">
                                <div class="blog-date">
                                    <ul>
                                        <li><i class="far fa-calendar-alt"></i> 14 Sep 2021</li>
                                        <li><i class="far fa-comment"></i> No Comments</li>
                                    </ul>
                                </div>
                                <h4><a href="blog-details.html">5 Simple Tricks For Getting Stellar Hotel Service</a></h4>
                                <a class="read-more-button" href="blog-details.html">Read More</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="paginations mt-30">
                    <ul>
                        <li class="active"><a href="posted-by.html">1</a></li>
                        <li><a href="posted-by.html">2</a></li>
                        <li><a href="posted-by.html">3</a></li>
                        <li><a href="posted-by.html">Next</a></li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            <div class="footer-logo-area">
                                ...
                                <div class="footer-contact">
                                    <ul>
                                        ...
                                        <li><a href="../../cdn-cgi/l/email-protection.html#432b262f2f2c0325262f223b6d202c2e"><i class="fas fa-envelope"></i> <span class="__cf_email__" data-cfemail="84ece1e8e8ebc4e2e1e8e5fcaae7ebe9">[email&#160;protected]</span></a></li>
