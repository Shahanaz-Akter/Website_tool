...
<html lang="zxx">
    ...
    <body>
                            ...
                            <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                                <ul class="navbar-nav">
                                    <li class="nav-item plus-icon">
                                        <a href="booking.html#" class="nav-link dropdown-toggle">Home <i class="fas fa-angle-down"></i></a>
                                    ...
                                    <li class="nav-item">
                                        <a href="booking.html#" class="nav-link dropdown-toggle">Rooms<i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="booking.html#" class="nav-link dropdown-toggle">Services<i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="booking.html#" class="nav-link dropdown-toggle active">Pages <i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="nav-item"><a href="booking.html" class="nav-link active">Room Booking</a></li>
                                    ...
                                    <li class="nav-item">
                                        <a href="booking.html#" class="nav-link dropdown-toggle">Blog <i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
        ...
        <!-- Booking area Start -->
        <div class="booking pt-70 pb-100 inner-booking">
            <div class="container">
                <form>
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                            <div class="booking-form-card-3">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="booking-form-card-3">
                                <label for="commnets">Special Requirements:</label>
                                <textarea id="commnets" rows="7" placeholder="Special Requirements.." class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="booking-form-card-3">
                                <button class="default-button" type="submit">Book Now</button>
                            </div>
                        </div>
                    </div>
                </form>
                            ...
                            <div class="footer-logo-area">
                                ...
                                <div class="footer-contact">
                                    <ul>
                                        ...
                                        <li><a href="../../cdn-cgi/l/email-protection.html#2f474a4343406f494a434e57014c4042"><i class="fas fa-envelope"></i> <span class="__cf_email__" data-cfemail="dbb3beb7b7b49bbdbeb7baa3f5b8b4b6">[email&#160;protected]</span></a></li>
