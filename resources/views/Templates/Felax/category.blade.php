                            ...
                            <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                                <ul class="navbar-nav">
                                    <li class="nav-item plus-icon">
                                        <a href="category.html#" class="nav-link dropdown-toggle">Home <i class="fas fa-angle-down"></i></a>
                                    ...
                                    <li class="nav-item">
                                        <a href="category.html#" class="nav-link dropdown-toggle">Rooms<i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="category.html#" class="nav-link dropdown-toggle">Services<i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="category.html#" class="nav-link dropdown-toggle active">Pages <i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                            <li class="nav-item"><a href="about.html" class="nav-link">About Us</a></li>
                                            <li class="nav-item"><a href="faq.html" class="nav-link">FAQ</a></li>
                                            <li class="nav-item"><a href="team.html" class="nav-link">Our Team</a></li>
                                            <li class="nav-item"><a href="pricing.html" class="nav-link">Pricing Plan</a></li>
                                            <li class="nav-item"><a href="category.html" class="nav-link active">Categories</a></li>
                                    ...
                                    <li class="nav-item">
                                        <a href="category.html#" class="nav-link dropdown-toggle">Blog <i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                            ...
                            <div class="footer-logo-area">
                                ...
                                <div class="footer-contact">
                                    <ul>
                                        ...
                                        <li><a href="../../cdn-cgi/l/email-protection.html#a8c0cdc4c4c7e8cecdc4c9d086cbc7c5"><i class="fas fa-envelope"></i> <span class="__cf_email__" data-cfemail="741c1118181b34121118150c5a171b19">[email&#160;protected]</span></a></li>
