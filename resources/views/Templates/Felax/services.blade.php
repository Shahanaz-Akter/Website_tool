...
<html lang="zxx">
    ...
    <body>
                            ...
                            <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                                <ul class="navbar-nav">
                                    <li class="nav-item plus-icon">
                                        <a href="services.html#" class="nav-link dropdown-toggle">Home <i class="fas fa-angle-down"></i></a>
                                    ...
                                    <li class="nav-item">
                                        <a href="services.html#" class="nav-link dropdown-toggle">Rooms<i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="services.html#" class="nav-link dropdown-toggle active">Services<i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="services.html#" class="nav-link dropdown-toggle">Pages <i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="services.html#" class="nav-link dropdown-toggle">Blog <i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
        ...
        <div class="amenities inner-amenities pt-70 pb-100">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="amenities-card-2">
                            <div class="amenities-card-header">
                                <i class="flaticon-swimming-pool"></i>
                                <h4><a href="service-details.html">Swimming Pool</a></h4>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="amenities-card-2">
                            <div class="amenities-card-header">
                                ...
                                <h4><a href="service-details.html">Best Hospitality</a></h4>
                            </div>
                            <p>Lorem ipsum dolor sit amet, consectetur adipicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="amenities-card-2">
                            <div class="amenities-card-header">
                                ...
                                <h4><a href="service-details.html">Free Wi-Fi</a></h4>
                            </div>
                            <p>Lorem ipsum dolor sit amet, consectetur adipicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="amenities-card-2">
                            <div class="amenities-card-header">
                                ...
                                <h4><a href="service-details.html">Room Service</a></h4>
                            </div>
                            <p>Lorem ipsum dolor sit amet, consectetur adipicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="amenities-card-2">
                            <div class="amenities-card-header">
                                ...
                                <h4><a href="service-details.html">Free Parking Lots</a></h4>
                            </div>
                            <p>Lorem ipsum dolor sit amet, consectetur adipicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
                    </div>
                ...
                <div class="paginations mt-30">
                    <ul>
                        <li class="active"><a href="services.html">1</a></li>
                            ...
                            <div class="footer-logo-area">
                                ...
                                <div class="footer-contact">
                                    <ul>
                                        ...
                                        <li><a href="../../cdn-cgi/l/email-protection.html#99f1fcf5f5f6d9fffcf5f8e1b7faf6f4"><i class="fas fa-envelope"></i> <span class="__cf_email__" data-cfemail="e8808d848487a88e8d848990c68b8785">[email&#160;protected]</span></a></li>
