                            ...
                            <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                                <ul class="navbar-nav">
                                    <li class="nav-item plus-icon">
                                        <a href="service-details.html#" class="nav-link dropdown-toggle">Home <i class="fas fa-angle-down"></i></a>
                                    ...
                                    <li class="nav-item">
                                        <a href="service-details.html#" class="nav-link dropdown-toggle">Rooms<i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="service-details.html#" class="nav-link dropdown-toggle active">Services<i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="service-details.html#" class="nav-link dropdown-toggle">Pages <i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="service-details.html#" class="nav-link dropdown-toggle">Blog <i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="service-details-text-area">
                            <img class="sd-main-img" src="assets/images/inner-images/sd1.jpg" alt="image">
                            <h3>The Felax Hotel & Resort</h3>
                            <p>Hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal bbelongs to those who fail in their duty through weakness of will, which is the same as saying through shrinking from toil and pain.</p>
                            <p>These cases are perfectly simple and easy to distinguish. In a free hour, when our power of choice is untrammelled andnothing prevents our being able to do what we like best, every pleasure is to be welcomed and every pain avoided. But in crumstances and owing to the claims of duty or the obligations of business it will frequently occur that pleasures have.</p>
                            <h3>Why Choose This Service</h3>
                            <div class="row justify-content-center">
                                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div class="why-we-card-3 why-we-card-4">
                                        <div class="why-we-icon-3">
                                            <img class="shape1" src="assets/images/shapes/shape-icon-1.png" alt="image">
                                            <img class="shape2" src="assets/images/shapes/shape-icon-2.png" alt="image">
                                            <i class="flaticon-value"></i>
                                        </div>
                                        <h4><a href="service-details.html">Our Customers</a></h4>
                                        <p>Lorem ipsum dolor sit sectetur adipising elit, sed  eiusmod</p>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div class="why-we-card-3 why-we-card-4">
                                        ...
                                        <h4><a href="service-details.html">Our Rooms</a></h4>
                                        <p>Lorem ipsum dolor sit sectetur adipising elit, sed  eiusmod</p>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div class="why-we-card-3 why-we-card-4">
                                        <div class="why-we-icon-3">
                                            <img class="shape1" src="assets/images/shapes/shape-icon-1.png" alt="image">
                                            <img class="shape2" src="assets/images/shapes/shape-icon-2.png" alt="image">
                                            <i class="flaticon-room-service-1"></i>
                                        </div>
                                        <h4><a href="service-details.html">Our Services</a></h4>
                                        <p>Lorem ipsum dolor sit sectetur adipising elit, sed  eiusmod</p>
                                    </div>
                                </div>
                            </div>
                            <ul>
                                <li>These cases are perfectly simple and easy.</li>
                                <li>In a free hour, when our power of choice.</li>
                                <li>They cannot foresee the pain and trouble.</li>
                                <li>The same as saying through shrinking.</li>
                            </ul>
                            <p>Hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal bbelongs to those who fail in their duty through weakness of will, which is the same as saying through shrinking from toil and pain.</p>
                    ...
                    <div class="col-lg-4">
                        <div class="sidebar pt-30">
                            <div class="sidebar-card service-sidebar">
                                <h3>All Services</h3>
                                <ul>
                                    <li><i class="fas fa-angle-right"></i> <a href="https://templates.envytheme.com/felax/default/service-deatils.html">Airport Transfer</a></li>
                                    <li><i class="fas fa-angle-right"></i> <a href="service-details.html">Fibre Internet</a></li>
                                    <li><i class="fas fa-angle-right"></i> <a href="service-details.html"> Equipped Kitchen</a></li>
                                    <li><i class="fas fa-angle-right"></i> <a href="service-details.html"> Smart TV</a></li>
                                    <li><i class="fas fa-angle-right"></i> <a href="service-details.html"> Card Access</a></li>
                                    <li><i class="fas fa-angle-right"></i> <a href="service-details.html"> Housekeeping</a></li>
                                </ul>
                            </div>
                            <div class="sidebar-card call-sidebar-card mt-30">
                                <h3>Request A Call back</h3>
                                <a href="tel:+0086578784"><i class="fas fa-phone-alt"></i> (+008) 6578 784 </a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="footer-logo-area">
                                ...
                                <div class="footer-contact">
                                    <ul>
                                        ...
                                        <li><a href="../../cdn-cgi/l/email-protection.html#d1b9b4bdbdbe91b7b4bdb0a9ffb2bebc"><i class="fas fa-envelope"></i> <span class="__cf_email__" data-cfemail="69010c050506290f0c050811470a0604">[email&#160;protected]</span></a></li>
