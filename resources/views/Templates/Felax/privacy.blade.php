    ...
    <body>
                            ...
                            <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                                <ul class="navbar-nav">
                                    <li class="nav-item plus-icon">
                                        <a href="privacy.html#" class="nav-link dropdown-toggle">Home <i class="fas fa-angle-down"></i></a>
                                    ...
                                    <li class="nav-item">
                                        <a href="privacy.html#" class="nav-link dropdown-toggle">Rooms<i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="privacy.html#" class="nav-link dropdown-toggle">Services<i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="privacy.html#" class="nav-link dropdown-toggle active">Pages <i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="privacy.html#" class="nav-link dropdown-toggle">Blog <i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
        ...
        <div class="terms ptb-100">
            <div class="container">
                ...
                <p>This site is provided by <strong>Felax</strong>. <strong>Felax</strong> collects information in several ways from different parts of this site.</p>
                <ul>
                ...
                <p><Strong>Felax</Strong> accepts the following payment methods:</p>
                <ul class="payment">
                    ...
                    <li><strong>Felax</strong> features a Fast Checkout option, allowing you to securely save your credit card details so that you don't have to re-enter them for future purchases.</li>
                </ul>
                ...
                <ul>
                    ...
                    <li><span>2.</span> <strong>Felax</strong> features a Fast Checkout option, allowing you to securely save your credit card details so that you don't have to re-enter them for future purchases.</li>
                </ul>
            </div>
        </div>
        <!-- terms area end -->
                            ...
                            <div class="footer-logo-area">
                                ...
                                <div class="footer-contact">
                                    <ul>
                                        ...
                                        <li><a href="../../cdn-cgi/l/email-protection.html#84ece1e8e8ebc4e2e1e8e5fcaae7ebe9"><i class="fas fa-envelope"></i> <span class="__cf_email__" data-cfemail="375f525b5b587751525b564f1954585a">[email&#160;protected]</span></a></li>
