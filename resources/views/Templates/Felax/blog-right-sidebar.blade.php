                            ...
                            <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                                <ul class="navbar-nav">
                                    <li class="nav-item plus-icon">
                                        <a href="blog-right-sidebar.html#" class="nav-link dropdown-toggle">Home <i class="fas fa-angle-down"></i></a>
                                    ...
                                    <li class="nav-item">
                                        <a href="blog-right-sidebar.html#" class="nav-link dropdown-toggle">Rooms<i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="blog-right-sidebar.html#" class="nav-link dropdown-toggle">Services<i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="blog-right-sidebar.html#" class="nav-link dropdown-toggle">Pages <i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="blog-right-sidebar.html#" class="nav-link dropdown-toggle active">Blog <i class="fas fa-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="nav-item"><a href="blog-right-sidebar.html" class="nav-link active">Blog Right Sidebar</a></li>
            ...
            <div class="container">
                <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="blog-card-2 mt-0">
                                    ...
                                    <div class="blog-card-text">
                                        ...
                                        <h4><a href="blog-details.html">The Seven People You Always Meet Hostelling</a></h4>
                                        <a class="read-more-button" href="blog-details.html">Read More</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="blog-card-2">
                                    ...
                                    <div class="blog-card-text">
                                        <div class="blog-date">
                                            <ul>
                                                <li><i class="far fa-calendar-alt"></i> 06 Sep 2021</li>
                                                <li><i class="far fa-comment"></i> No Comments</li>
                                            </ul>
                                        </div>
                                        <h4><a href="blog-details.html">Benefits Of Online Registration at Your Hotel</a></h4>
                                        <a class="read-more-button" href="blog-details.html">Read More</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="blog-card-2">
                                    ...
                                    <div class="blog-card-text">
                                        <div class="blog-date">
                                            <ul>
                                                <li><i class="far fa-calendar-alt"></i> 08 Sep 2021</li>
                                                <li><i class="far fa-comment"></i> No Comments</li>
                                            </ul>
                                        </div>
                                        <h4><a href="blog-details.html">Cottonwood Established  Resort & Marina</a></h4>
                                        <a class="read-more-button" href="blog-details.html">Read More</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="blog-card-2">
                                    ...
                                    <div class="blog-card-text">
                                        <div class="blog-date">
                                            <ul>
                                                <li><i class="far fa-calendar-alt"></i> 10 Sep 2021</li>
                                                <li><i class="far fa-comment"></i> No Comments</li>
                                            </ul>
                                        </div>
                                        <h4><a href="blog-details.html">Hotel June’s Upcoming Artist In Residence</a></h4>
                                        <a class="read-more-button" href="blog-details.html">Read More</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                        <div class="sidebar-content pl-20 pt-30">
                            ...
                            <div class="footer-logo-area">
                                ...
                                <div class="footer-contact">
                                    <ul>
                                        ...
                                        <li><a href="../../cdn-cgi/l/email-protection.html#96fef3fafaf9d6f0f3faf7eeb8f5f9fb"><i class="fas fa-envelope"></i> <span class="__cf_email__" data-cfemail="8ce4e9e0e0e3cceae9e0edf4a2efe3e1">[email&#160;protected]</span></a></li>
